...
function Permission() {
  ...
  const [permissions, setPermissions] = useState([
    ...
    { id: 5, name: "Manage Settings" },
    { id: 6, name: "Assign Roles" },
    { id: 7, name: "Read Only" },
    { id: 8, name: "Export Data" },
    { id: 9, name: "Access Admin Panel" },
    { id: 10, name: "Change Password" },
    { id: 11, name: "Manage Billing" },
    { id: 12, name: "View Logs" },
    { id: 13, name: "Backup Database" },
    { id: 14, name: "Create Reports" },
    { id: 15, name: "Invite Members" },
  ]);
  ...
  return (
    <div className="font-poppins">
      <p className="text-sm text-cyan-700 mb-4 font-medium">
        <span className="text-gray-500">\</span> Permissions
      </p>
          ...
          >
            ...
            >
              ...
              <h2 className="text-xl font-semibold mb-5 border-b border-cyan-300 pb-2 text-cyan-700">
                {editId !== null ? "Update Permission" : "Create New Permission"}
              </h2>
